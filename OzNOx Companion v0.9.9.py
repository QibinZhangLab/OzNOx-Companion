        ...
        for group_i in sample_definitions_groups:
            ...
            if proceed:
                ...
                for nonzero_scan_index in nonzero_scan_indexes:
                    ...
                    print('nonzero_scan_index: ' + str(nonzero_scan_index)) # delete me
                    ...
                    for unique_key_this_scan in all_unique_keys_this_scan:
                        ...
                        print('unique_key_this_scan: ' + str(unique_key_this_scan)) # delete me
                        print('key_spectrum_value: ' + str(key_spectrum_value)) # delete me
            ...
            print('total_solvable_counts: ' + str(total_solvable_counts))  # delete me
            print('proceed_threshold: ' + str(proceed_threshold))  # delete me

            if total_solvable_counts < proceed_threshold:
                proceed = False
                print('Fail threshold.')  # delete me
            else: # delete me
                print('Pass threshold.') # delete me
            print('') # delete me
...
def main():
    ...
    version_number_string = 'v0.9.9'
    version_description_string = 'Pre-Publication Version'
    ...
    print('Smith, R.; Omar, A.; Mulani, F.; Zhang, Q. OzNOxESI: A novel mass spectrometry ion chemistry for')
    print('elucidating lipid double-bond regioisomerism in complex mixtures. Journal Name XX, XXXX (2024).')
    print('')
